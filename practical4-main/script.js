...
/* city1.getName = cityName; 
city2.getName = 'cityName';
...
/* const city1 = {
    name: 'Архангельск',
    getName: (name) => this.city1,
};
const city2 = {
    name: 'Уфа',
    getName: (name) => this.city2,
};
console.log(getName(name)); */

/* let cities.getName = [city1, city2]; */


// Создайте мexportStr() у каждого из объектов. Этот метод должен 
...
/* function exportStr() {
    console.log(name ='ГородN', population = 10);
}
